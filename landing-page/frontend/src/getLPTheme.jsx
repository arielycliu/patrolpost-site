...
export const brand = {
    50: 'hsl(207, 100%, 97%)', // 210, 100%, 97%
    100: 'hsl(207, 100%, 95%)', // 210, 100%, 90%
    200: 'hsl(207, 100%, 90%)', // 210, 100%, 80%
    300: 'hsl(207, 100%, 80%)', // 210, 100%, 65%
    400: 'hsl(207, 98%, 75%)', // 210, 98%, 48%
    500: 'hsl(207, 98%, 69%)', // 210, 98%, 42%
    600: 'hsl(207, 98%, 82%)', // 210, 98%, 55%
    700: 'hsl(207, 100%, 62%)', // 210, 100%, 35%
    800: 'hsl(207, 100%, 42%)', // 210, 100%, 16%
    900: 'hsl(207, 100%, 48%)', // 210, 100%, 21%
};
